...
def get_graph(coordinates, name):
    script_path = "../script/graph.py"
    result = subprocess.run(
        ["python", script_path, coordinates, name], capture_output=True, text=True
    )
    print("the result is:")
    print(result.stdout)
